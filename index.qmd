...
# Create enhanced expected value plot with better design
ggplot(ev_data, aes(x = Years)) +
  # Add background ribbon to show the divergence
  geom_ribbon(aes(ymin = Geometric_Mean, ymax = Expected_Value), 
              fill = "lightblue", alpha = 0.3) +
  # Add the lines with proper linewidth
  geom_line(aes(y = Expected_Value, color = "Expected Value (Arithmetic)"), 
            linewidth = 2.5, alpha = 0.9) +
  geom_line(aes(y = Geometric_Mean, color = "Geometric Mean"), 
            linewidth = 2.5, alpha = 0.9) +
  # Add reference line for initial balance
  geom_hline(yintercept = initial_balance, linetype = "dashed", 
             color = "darkred", linewidth = 1.2, alpha = 0.8) +
  # Add data points with better styling
  geom_point(aes(y = Expected_Value), color = "#1f77b4", size = 4, alpha = 0.8) +
  geom_point(aes(y = Geometric_Mean), color = "#d62728", size = 4, alpha = 0.8) +
  # Add annotations for key insights
  annotate("text", x = 8, y = 15000, 
           label = "Arithmetic Mean\n(Overestimates)", 
           color = "#1f77b4", size = 3.5, fontface = "bold") +
  annotate("text", x = 8, y = 800, 
           label = "Geometric Mean\n(Realistic)", 
           color = "#d62728", size = 3.5, fontface = "bold") +
  annotate("text", x = 2, y = 1100, 
           label = "Initial Balance\n$1,000", 
           color = "darkred", size = 3, fontface = "bold") +
  # Scales and formatting
  scale_y_continuous(labels = scales::dollar_format(), 
                     trans = "log10",
                     breaks = c(100, 500, 1000, 2000, 5000, 10000, 20000, 50000)) +
  scale_x_continuous(breaks = 1:10) +
  scale_color_manual(values = c("Expected Value (Arithmetic)" = "#1f77b4", 
                               "Geometric Mean" = "#d62728")) +
  labs(
    title = "Expected Value Analysis: The Arithmetic vs. Geometric Mean Paradox",
    subtitle = "Why positive expected value can lead to losses in multiplicative processes",
    x = "Number of Years (Coin Flips)",
    y = "Expected Balance (Log Scale)",
    color = "Calculation Method",
    caption = "Red dashed line: Initial balance | Blue ribbon: Divergence between methods"
  ) +
  theme_minimal() +
  theme(
...
# Add key insights
cat("\n")
cat("## 🎯 **Key Comparison Insights:**\n")
cat("• **Capital Preservation**: Strategy 2 is safer (39% vs 30% chance of keeping your $1,000)\n")
cat("• **Growth Potential**: Strategy 1 offers higher rewards (2% vs 0% chance of reaching $10,000)\n")
cat("• **Risk vs Reward**: Full investment is riskier but has potential for massive gains\n")
cat("• **Conservative Approach**: 50% investment strategy prioritizes capital preservation over growth\n")
```
